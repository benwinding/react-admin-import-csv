...
exports.ImportButton = function (props) {
    var messages = {
        ...
        ch: __assign(__assign({}, ra_language_chinese_1.default), domainMessages.ch),
    };
    var i18nProvider = ra_i18n_polyglot_1.default(function (locale) { return (messages[locale] ? messages[locale] : messages.en); }, react_admin_1.resolveBrowserLocale());
