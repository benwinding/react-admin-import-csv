...
var setObjectValue = function (object, path, value) {
    var lensPathFunction = lensPath(path.split("."));
    return over(lensPathFunction, function () { return value; }, object || {});
};
export function processCsvFile(file, parseConfig) {
...
export function getCsvData(file, inputConfig) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    return convertFromCSV(file, __assign(__assign({ 
                        // Defaults
